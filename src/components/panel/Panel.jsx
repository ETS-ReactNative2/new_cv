...
import Experiences from "../professionnal/Experiences";
...
const PanelStyle = styled.div`
  ...
  &:nth-child(1) {
    ...
    transition: opacity ${props => props.transitionDuration + 100}ms
      cubic-bezier(1, 0, 1, 0.3);
  }
  ...
  &:nth-child(4) {
    ...
    transition: opacity ${props => props.transitionDuration + 200}ms
      cubic-bezier(1, 0, 1, 0.3);
  }
  ...
  & > div {
    ...
    background: linear-gradient(
        45deg,
        rgba(201, 214, 255, ${props => (props.index !== -1 ? 0.85 : 0.4)}),
        rgba(226, 226, 226, ${props => (props.index !== -1 ? 0.85 : 0.4)})
      ),
      url(${props => props.bg});
    ...
    transition: width ${props => props.transitionDuration}ms ease,
      height ${props => props.transitionDuration}ms ease,
      transform ${props => props.transitionDuration}ms ease,
      background-image ${props => props.transitionDuration}ms ease;
    ...
    & > section {
      ...
      transition: transform ${props => props.transitionDuration}ms
        ${props => (props.index === -1 ? 0 : 300)}ms ease;
